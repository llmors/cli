...
use Llmor\Cli\Command\Apps\ImportCommand as AppsImportCommand;
...
use Llmor\Cli\Command\Model\ListCommand as ModelListCommand;
...
final class Application extends BaseApplication
{
    ...
    public function __construct(?Services $services = null, ?ConfigResolver $resolver = null)
    {
        ...
        $this->addCommands([
            ...
            new ModelListCommand($services->client, $services->config->vendor),
            new SyncCommand($services->client, $services->config->vendor, $workingDir),
            new AppsImportCommand($services->client, $services->config->vendor, $workingDir),
            ...
            new TestCommand($services->client, $services->config->vendor, $workingDir),
